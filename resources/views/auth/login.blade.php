...
@section('content')
      ...
      <div class="lg:w-1/2 lg:mx-auto bg-white p-6 md:py-12 md:px-16 rounded shadow">
            <div class="text-center text-xl">{{ __('Login') }}</div>
             <div class="my-4">
                        <form  method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-8 offset-md-4">
                                    <button
                                            type="submit"
                                            class="bg-blue text-sm text-white font-semibold my-4 py-2 px-5 border border-gray-400 rounded-lg shadow">
                                        {{ __('Login') }}
                                    </button>

                                    @if (Route::has('password.request'))
                                        <a class="text-gray-700 mx-10 underline" href="{{ route('password.request') }}">
